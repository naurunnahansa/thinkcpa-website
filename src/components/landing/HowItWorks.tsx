...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="py-16 md:py-28 bg-white border-t">
        ...
        <div className="grid gap-6 md:gap-12 md:grid-cols-2 lg:grid-cols-4">
          {steps.map((step, index) => (
            <div key={step.number} className="relative">
              {/* Large step number */}
              <p className="font-display text-5xl md:text-8xl lg:text-9xl font-black text-primary/10 leading-none mb-4">
                {step.number}
              </p>
