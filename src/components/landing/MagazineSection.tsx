  ...
  return (
    <>
      ...
      <section className="grid lg:grid-cols-2 border-t">
        <div className="flex items-center py-20 lg:py-28 px-8 lg:px-16 xl:px-24 bg-white">
      ...
      <section className="grid lg:grid-cols-2 border-t">
        ...
        <div className="flex items-center py-20 lg:py-28 px-8 lg:px-16 xl:px-24 bg-accent order-1 lg:order-2">
          <div className="max-w-xl">
      ...
      <section className="grid lg:grid-cols-2 border-t">
        <div className="flex items-center py-20 lg:py-28 px-8 lg:px-16 xl:px-24 bg-primary">
          <div className="max-w-xl">
